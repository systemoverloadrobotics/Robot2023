...
public class ArmSubsystem extends SubsystemBase {
    ...
    //@formatter:off
    LOW(new Pair<Double, Double>(Constants.Arm.ARM_PRESET_LOW_ANGLE,Constants.Arm.ARM_PRESET_NO_EXTENSION)),
    GROUND_INTAKE(new Pair<Double, Double>(Constants.Arm.ARM_PRESET_LOW_ANGLE,Constants.Arm.ARM_PRESET_LOW_LENGTH)),
